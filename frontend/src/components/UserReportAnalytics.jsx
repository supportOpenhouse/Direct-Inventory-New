...
const STAGE_ORDER = ['lead', 'qualified', 'call_not_received', 'follow_up', 'visit_scheduled', 'visit_completed', 'offer_given', 'rejected'];
const FUNNEL_STAGES = ['qualified', 'visit_scheduled', 'visit_completed', 'offer_given'];
const STAGE_COLOR = {
  lead: '#fa541c', qualified: '#16a34a', call_not_received: '#EF9F27', follow_up: '#f97316',
